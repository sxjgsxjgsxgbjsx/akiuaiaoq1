...
def start_bot(context: CallbackContext):
  try:
    # Use the appropriate import for ParseMode (if needed - it might already be available)
    from telegram import ParseMode
    context.bot.send_message(chat_id=admin_id, text="Bot started!", parse_mode=ParseMode.HTML)
  except ImportError:
    # If ParseMode is not available, send the message without it
    context.bot.send_message(chat_id=admin_id, text="Bot started!")
  except Exception as e:
